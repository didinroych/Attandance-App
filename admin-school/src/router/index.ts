...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => import('../views/Admin/ClassScheduleManagement.vue'),
      meta: {
    ...
    },
    {
      ...
      name: 'ScheduleBulkPreview',
      component: () => import('../views/Admin/ScheduleBulkPreview.vue'),
      meta: {
        title: 'Schedule Bulk Upload Preview',
        requiresAuth: true,
        requiresRole: 'admin',
      },
    },
