            ...
            >
              <template #instructions>
                ...
                <ul class="list-inside list-disc space-y-1">
                  <li><strong>Required:</strong> username, email, password, teacherId, fullName</li>
                  <li><strong>Optional:</strong> phone, address, hireDate</li>
                </ul>
                <button
...
import { parseTeacherCSV, generateTeacherCSVTemplate, downloadCSVTemplate } from '@/utils/csvParser'
...
const handleFileSelected = async (file: File) => {
  try {
    const result = await parseTeacherCSV(file)
