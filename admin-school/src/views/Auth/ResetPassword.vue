              ...
              <div>
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <p v-if="newPassword !== confirmPassword && confirmPassword" class="text-xs text-error-500">
...
const handleSubmit = async () => {
  if (!email.value || !otp.value || !newPassword.value || newPassword.value !== confirmPassword.value) {
    return
  }
  ...
  try {
    ...
    success.value = 'Password reset successful! Redirecting to sign in...'
